...
$(document).ready(function () {
    ...
    var set_menuup_center = function () {
        $('.menuup').each(function (i, pEl) {
    ...
    if (!$('#quick_login_menuup').length) {
        $('<div id="quick_login_menuup"></div>').appendTo('body');
    }
    var DcQuickLogin = new QuickLoginView();
    //init notification menuup
    if (!$('#site_notification_menuup').length) {
        $('<div id="site_notification_menuup"></div>').appendTo('body');
    }
    var DcNotificationmenuupView = new NotificationmenuupView();
    //#request_consultation_menuup
    if (!$('#request_consultation_menuup').length) {
        $('<div id="request_consultation_menuup"></div>').appendTo('body');
    }
    ...
    if (!$('#subscribe_email_menuup').length) {
        $('<div id="subscribe_email_menuup"></div>').appendTo('body');
    }
